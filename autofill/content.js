...
function fillMinPoints() {
  ...
  inputs.forEach(input => {
    // Lấy giá trị 0 từ thuộc tính aria-valuemax
    const minValue = input.getAttribute('aria-valuemin');
...
// Ở đây ta có thể chạy ngay bằng cách nhấn Alt + Shift + D (ví dụ)
document.addEventListener('keydown', (e) => {
